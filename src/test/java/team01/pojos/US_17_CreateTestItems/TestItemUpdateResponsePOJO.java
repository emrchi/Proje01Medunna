...
public class TestItemUpdateResponsePOJO implements Serializable {
	...
	public TestItemUpdateResponsePOJO() {
	}

	public TestItemUpdateResponsePOJO(String createdBy, String createdDate, int id, String name, String description, int price, String defaultValMin, String defaultValMax) {
